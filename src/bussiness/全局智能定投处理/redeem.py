...
def redeem(user: User, plan_detail: FundPlanDetail) -> bool:
    ...
    if shares is not None:
        ...
        if estimated_profit_rate > 3.0 and CurrentRealBalance < BANK_BALANCE_THRESHOLD and fund_type in ['001','002'] and rank_100 is not None and times < 5.0 and estimated_change > 0.5:

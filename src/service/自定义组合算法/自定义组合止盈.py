...
def redeem_funds(user: User, sub_account_name: str, fund_list: Optional[list] = None) -> bool:
    ...
    for asset in assets:
        try:
            ...
            if fund_type == '000' and fund_type != 'a' and "QDII" not in fund_name and hqb_ratio_percent < HQB_RATIO_THRESHOLD and estimated_change > 0.5 and estimated_profit_rate > 1.0:
                logger.info(

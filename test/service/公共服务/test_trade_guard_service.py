...
def test_has_buy_submission_on_prev_nav_and_today():
    ...
    fund_code = "015916"
    fi = get_all_fund_info(DEFAULT_USER, fund_code)
    ...
    # 加仓前检查
    prev_trade_pre = has_buy_submission_on_dates(DEFAULT_USER, sub_account_no, fund_code, prev_trade_day)
    today_trade_pre = has_buy_submission_on_dates(DEFAULT_USER, sub_account_no, fund_code, today)
